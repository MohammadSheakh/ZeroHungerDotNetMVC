        ...
        public ActionResult CreateNewFoodItem(FoodItemDTO foodItemDto)
        {
            if (Session["userId"] != null)
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    TempData["nameValidationForCreateFoodItem"] = null;
                    TempData["quantityValidationForCreateFoodItem"] = null;
                    TempData["quantityUnitValidationForCreateFoodItem"] = null;
                    TempData["maxPreservationTimeValidationForCreateFoodItem"] = null;
                    return RedirectToAction("FoodSourceDashboard");
                }
                else
                {
